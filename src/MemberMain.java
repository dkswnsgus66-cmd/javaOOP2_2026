...
public class MemberMain {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("7. 나이범위 검색");
            System.out.println("8. 이메일로 검색");
            ...
            if (choice.equals("1")) {
                ...
                if (result.isEmpty()) { // 데이터가 있는지 확인 비었으면 false 안비었으면 true
                    System.out.println("해당 나이의 회원이 없습니다.");
                } else {
                    for (Member m : result) { // 걸러져 나온 나이 범위를 m 으로 만들어 호출
                        System.out.println(m);
                    }
                }
